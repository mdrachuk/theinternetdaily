...
_SYSTEM = (
    ...
    "- Output language: the SAME language the source is written in. Do NOT translate it, not even partly. A Russian article stays Russian, a German one stays German. You are copy-editing, not translating.\n"
    "\n"
    "PARAGRAPH STRUCTURE:\n"
    ...
    "- Never translate or rename code, identifiers, or file paths.\n"
    "\n"
    "MATH (CRITICAL):\n"
